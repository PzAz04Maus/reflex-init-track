import type { CombatState, CharacterRecord, CharacterId, InitiativeState } from 'reflex-shared';
...
export declare function sortActors(list: CharacterRecord[]): CharacterRecord[];
/**
