    ...
    <div style={{ background: '#111', minHeight: '100vh', color: '#eee', fontFamily: 'sans-serif', padding: 0 }}>
      <div style={{ maxWidth: 400, margin: '0 auto', paddingTop: 40 }}>
        ...
        <div style={{ background: '#388e3c', color: '#111', borderRadius: 6, boxShadow: '0 2px 8px #0008', padding: 16, marginBottom: 8, position: 'relative' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <input
              ...
              onChange={(event) => dispatch({ type: 'setActionCost', actorId: currentActor?.id, actionCost: Number(event.target.value) })}
            />
            <button
        ...
        <div style={{ display: 'flex', gap: 8, margin: '12px 0' }}>
          ...
          />
          <button onClick={handleAddActor} style={{ borderRadius: 4, background: '#444', color: '#fff', border: 'none', padding: '6px 16px', fontSize: 16 }}>
            Add
          </button>
        </div>
        ...
        <div style={{ textAlign: 'center', marginBottom: 16 }}>
          <button onClick={handleReset} style={{ borderRadius: 4, background: '#888', color: '#fff', border: 'none', padding: '6px 16px', fontSize: 16 }}>
            Reset
          </button>
        </div>
      </div>
