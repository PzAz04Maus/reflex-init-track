...
exports.RANGED_CATALOG = exports.HEAVY_MACHINE_GUNS = exports.GENERAL_PURPOSE_MACHINE_GUNS = exports.SQUAD_AUTOMATIC_WEAPONS = exports.BREAK_ACTION_SHOTGUNS = exports.SEMI_AUTOMATIC_SHOTGUNS = exports.PUMP_ACTION_SHOTGUNS = exports.SEMI_AUTOMATIC_SNIPER_RIFLES = exports.BOLT_ACTION_SNIPER_RIFLES = exports.SEMI_AUTOMATIC_SERVICE_RIFLES = exports.BOLT_ACTION_SERVICE_RIFLES = exports.TARGET_AND_HUNTING_RIFLES = exports.ASSAULT_RIFLES = exports.SUBMACHINE_GUNS = exports.REVOLVERS = exports.AUTOLOADERS = exports.GENERIC_LONGRIFLE = void 0;
...
function parsePenetration(penetration) {
    const [optimum, maximum] = penetration.split("/");
    return { optimum, maximum };
}
function getFeedTags(capacity) {
...
function getVoucherCost(tags) {
    return { "held:hands": tags.includes("sidearm") ? 1 : 2 };
}
function getDefaultSupportedAttachmentKinds(tags, crewServed) {
    const kinds = new Set(["ammo-handling"]);
    const isLongarm = tags.some((tag) => ["rifle", "shotgun", "smg", "machine-gun", "assault-rifle", "battle-rifle", "service-rifle", "sniper-rifle", "dmr"].includes(tag));
...
function defineWeapon(entry) {
    ...
    return (0, inventory_1.createRangedWeaponDefinition)({
...
exports.GENERIC_LONGRIFLE = defineWeapon({
...
exports.TARGET_AND_HUNTING_RIFLES = [
...
exports.BOLT_ACTION_SERVICE_RIFLES = [
...
exports.SEMI_AUTOMATIC_SERVICE_RIFLES = [
...
exports.BOLT_ACTION_SNIPER_RIFLES = [
...
exports.SEMI_AUTOMATIC_SNIPER_RIFLES = [
...
exports.SEMI_AUTOMATIC_SHOTGUNS = [
...
exports.SQUAD_AUTOMATIC_WEAPONS = [
...
exports.GENERAL_PURPOSE_MACHINE_GUNS = [
