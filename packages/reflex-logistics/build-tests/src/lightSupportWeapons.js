...
exports.LIGHT_SUPPORT_WEAPONS_RULES = exports.LIGHT_SUPPORT_WEAPONS_BY_ID = exports.LIGHT_SUPPORT_WEAPONS = void 0;
...
function directDamage(damage) {
    return [{ damage }];
}
function explosiveDamage(damage, radiusMeters, blast, frag) {
    return [{ damage, blast, frag, area: { kind: "radius", meters: radiusMeters } }];
}
exports.LIGHT_SUPPORT_WEAPONS = [
    {
...
exports.LIGHT_SUPPORT_WEAPONS_BY_ID = Object.fromEntries(exports.LIGHT_SUPPORT_WEAPONS.map((entry) => [entry.id, entry]));
exports.LIGHT_SUPPORT_WEAPONS_RULES = [
    {
