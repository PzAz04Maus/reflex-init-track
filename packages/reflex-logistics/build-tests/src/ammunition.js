...
exports.SMALL_ARMS_AMMUNITION_ITEMS = exports.SMALL_ARMS_AMMUNITION = exports.SHOTGUN_SHELLS = exports.RIFLE_CARTRIDGES = exports.PISTOL_CARTRIDGES = exports.SMALL_ARMS_AMMUNITION_RULES = void 0;
const inventory_1 = require("./inventory");
const SPECIAL_AMMO_MULTIPLIERS = {
    AP: 5,
    HP: 2,
    T: 4,
};
const SPECIAL_AMMO_LABELS = {
    AP: "Armor-Piercing",
    HP: "Hollowpoint",
    T: "Tracer",
};
exports.SMALL_ARMS_AMMUNITION_RULES = {
...
function parseBarterValue(value) {
    return Number(value.replace(/^GG/, "").replace(/,/g, ""));
}
function formatBarterValue(value) {
...
function getLotLabel(category) {
    return category === "shotgun-shell" ? "100 shells" : "100 rounds";
}
function getAvailableTypeLabel(types) {
    if (types.length === 0) {
        return undefined;
    }
    return types.map((type) => SPECIAL_AMMO_LABELS[type]).join(", ");
}
function createMagazineWeightNotes(magazineWeightNotes) {
...
function collectAmmoItems(definition) {
    return [
        definition.ball,
        definition.slug,
...
exports.PISTOL_CARTRIDGES = PISTOL_CARTRIDGE_ROWS.map(defineSmallArmsAmmunition);
exports.RIFLE_CARTRIDGES = RIFLE_CARTRIDGE_ROWS.map(defineSmallArmsAmmunition);
exports.SHOTGUN_SHELLS = SHOTGUN_SHELL_ROWS.map(defineSmallArmsAmmunition);
exports.SMALL_ARMS_AMMUNITION = [
    ...exports.PISTOL_CARTRIDGES,
    ...exports.RIFLE_CARTRIDGES,
    ...exports.SHOTGUN_SHELLS,
];
exports.SMALL_ARMS_AMMUNITION_ITEMS = exports.SMALL_ARMS_AMMUNITION.flatMap(collectAmmoItems);
