...
exports.MOUNTED_AND_DRAFT_RULES = exports.ANIMAL_TRAINING_LEVELS = exports.VEHICLE_CONVERSION_RULES = exports.TRUCK_VARIATION_RULE = exports.VEHICLE_EQUIPMENT_ROLE_CODES = void 0;
const shared_1 = require("./shared");
exports.VEHICLE_EQUIPMENT_ROLE_CODES = {
    id: "vehicle:equipment-role-codes",
    name: "Vehicle Equipment Role Codes",
    source: (0, shared_1.sources)(286),
...
exports.TRUCK_VARIATION_RULE = {
    id: "vehicle:truck-variations",
    name: "Truck Variations",
    source: (0, shared_1.sources)(285),
    traits: [
...
exports.VEHICLE_CONVERSION_RULES = [
    {
...
exports.ANIMAL_TRAINING_LEVELS = [
    {
        id: "animal-training:untrained",
        name: "Untrained",
        source: (0, shared_1.sources)(296),
...
exports.MOUNTED_AND_DRAFT_RULES = [
    {
    ...
    },
    {
        ...
        name: "Mounted Combat",
        source: (0, shared_1.sources)(296, 297),
        traits: [
