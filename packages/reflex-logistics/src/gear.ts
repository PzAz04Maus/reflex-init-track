...
import type { ArmorDefinition, ArmorInsertSlot, ItemDefinition, RangedWeaponDefinition } from "./types";
...
const TRAUMA_PLATE_SLOTS: ArmorInsertSlot[] = [
...
export const GENERIC_ARMOR: ArmorDefinition = createArmorDefinition({
...
export const GENERIC_LONGRIFLE: RangedWeaponDefinition = createRangedWeaponDefinition({
...
export const BODY_ARMORS: ArmorDefinition[] = [
  createArmorDefinition({
...
export const TRAUMA_PLATES: ArmorDefinition[] = [
  createArmorDefinition({
